...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        try {
            jPanel2 =(javax.swing.JPanel)java.beans.Beans.instantiate(getClass().getClassLoader(), "br/edu/ifnmg/masterclub/apresentacao.TelaPrincipal_jPanel2");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/img/MasteClubLogo.png"))); // NOI18N
        ...
        BarraMenuCadastro.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474060543_school_events.png"))); // NOI18N
        BarraMenuCadastro.setText("Cadastro");
        BarraMenuCadastro.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N

        ItemCadJogadores.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474063085_football.png"))); // NOI18N
        ...
        ItemCadComTecnica.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474063520_person_4.png"))); // NOI18N
        ItemCadComTecnica.setText("Comissão Técnica");
        BarraMenuCadastro.add(ItemCadComTecnica);

        ItemCadFuncionario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474063801_icon-person.png"))); // NOI18N
        ItemCadFuncionario.setText("Funcionários");
        BarraMenuCadastro.add(ItemCadFuncionario);

        ItemCadPatrocinadores.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474063975_nike.png"))); // NOI18N
        ...
        BarraMenuDepartamentos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474061041_companies.png"))); // NOI18N
        BarraMenuDepartamentos.setText("Departamentos");
        BarraMenuDepartamentos.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N

        jMenuItem1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474066799_Football_2-09.png"))); // NOI18N
        jMenuItem1.setText("Departamento de Futebol");
        BarraMenuDepartamentos.add(jMenuItem1);

        jMenuItem2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474067021_vector_65_10.png"))); // NOI18N
        jMenuItem2.setText("Departamento de Marketing");
        BarraMenuDepartamentos.add(jMenuItem2);

        ItemDepMedico.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474066900_cross_1.png"))); // NOI18N
        ItemDepMedico.setText("Departamento Médico");
        BarraMenuDepartamentos.add(ItemDepMedico);

        jMenuItem3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474066748_Football_2-17.png"))); // NOI18N
        jMenuItem3.setText("Infraestrutura");
        BarraMenuDepartamentos.add(jMenuItem3);

        BarraMenuTelaPrincipal.add(BarraMenuDepartamentos);

        BarraMenuCampeonato.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474061836_trophy.png"))); // NOI18N
        BarraMenuCampeonato.setText("Campeonatos");
        BarraMenuCampeonato.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N

        jMenuItem4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474067356_compose.png"))); // NOI18N
        jMenuItem4.setText("Inserir Torneio");
        BarraMenuCampeonato.add(jMenuItem4);

        jMenuItem5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474067408_calendar.png"))); // NOI18N
        jMenuItem5.setText("Temporada");
        BarraMenuCampeonato.add(jMenuItem5);

        jMenuItem6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474067531_trophy.png"))); // NOI18N
        jMenuItem6.setText("Títulos");
        BarraMenuCampeonato.add(jMenuItem6);

        BarraMenuTelaPrincipal.add(BarraMenuCampeonato);

        BarraMenuFinanceiro.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474060852_03.png"))); // NOI18N
        BarraMenuFinanceiro.setText("Financeiro");
        BarraMenuFinanceiro.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N

        jMenuItem7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474067819_vector_65_12.png"))); // NOI18N
        jMenuItem7.setText("Contratações");
        BarraMenuFinanceiro.add(jMenuItem7);

        jMenuItem8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474067951_finance-23.png"))); // NOI18N
        jMenuItem8.setText("Empréstimos");
        BarraMenuFinanceiro.add(jMenuItem8);

        jMenuItem9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474068036_Cart.png"))); // NOI18N
        jMenuItem9.setText("Vendas");
        BarraMenuFinanceiro.add(jMenuItem9);

        jMenuItem10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474067698_visa.png"))); // NOI18N
        jMenuItem10.setText("Patrocinadores");
        BarraMenuFinanceiro.add(jMenuItem10);

        BarraMenuTelaPrincipal.add(BarraMenuFinanceiro);

        BarraMenuSobre.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474061215_19.png"))); // NOI18N
        ...
        BarraMenuSair.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/masterclub/apresentacao/icone/1474061346_Shutdown_Box_Red.png"))); // NOI18N
